...
class ListTestInsertEnds : public stest::LeafTest {
public:
    ListTestInsertEnds() : LeafTest("insertEnds") {
    }
 ...
 */
template<class ListT>
class ListTestInsertRandom : public stest::LeafTest {
public:
    ListTestInsertRandom() : LeafTest("insertRandom") {
    }
 ...
 */
template<class ListT>
class ListTestCalculateIndex : public stest::LeafTest {
public:
    ListTestCalculateIndex() : LeafTest("calculateIndex") {
    }
 ...
 */
template<class ListT>
class ListTestAccessEnds : public stest::LeafTest {
public:
    ListTestAccessEnds() : LeafTest("accessEnds") {
    }
 ...
 */
template<class ListT>
class ListTestAccessRandom : public stest::LeafTest {
public:
    ListTestAccessRandom() : LeafTest("accessRandom") {
    }
 ...
 */
template<class ListT>
class ListTestSet : public stest::LeafTest {
public:
    ListTestSet() : LeafTest("set") {
    }
 ...
 */
template<class ListT>
class ListTestRemoveEnds : public stest::LeafTest {
public:
    ListTestRemoveEnds() : LeafTest("removeEnds") {
    }
 ...
 */
template<class ListT>
class ListTestRemoveRandom : public stest::LeafTest {
public:
    ListTestRemoveRandom() : LeafTest("removeRandom") {
    }
 ...
 */
template<class ListT>
class ListTestIterators : public stest::LeafTest {
public:
    ListTestIterators() : LeafTest("iterator") {
    }
 ...
 */
template<class ListT>
class ListTestClear : public stest::LeafTest {
public:
    ListTestClear() : LeafTest("clear") {
    }
 ...
 */
template<class ListT>
class ListTestCopyAssignEquals : public stest::LeafTest {
public:
    ListTestCopyAssignEquals() : LeafTest("copy-assign-equals") {
    }
...
protected:
    void test() override {
        ...
        this->assert_true(
            list1.equals(list2),
            "Copy constructed list is the same."
        );
        list1.removeLast();
        ...
        this->assert_false(
            list1.equals(list3),
            "Modified assigned list is different."
        );
    }
};
 ...
 */
template<class ListT>
class GeneralListTest : public stest::CompositeTest {
public:
    GeneralListTest(const std::string &name) : CompositeTest(name) {
 ...
 */
class ListTest : public stest::CompositeTest {
public:
    ListTest() : CompositeTest("List") {
        this->add_test(
            std::make_unique<GeneralListTest<adt::ImplicitList<int>>>(
                "ImplicitList"
            )
        );
        this->add_test(
            std::make_unique<GeneralListTest<adt::SinglyLinkedList<int>>>(
                "SinglyLinkedList"
            )
        );
        this->add_test(
            std::make_unique<GeneralListTest<adt::DoublyLinkedList<int>>>(
                "DoublyLinkedList"
            )
        );
    }
